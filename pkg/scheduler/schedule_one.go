...
func (sched *Scheduler) findNodesThatPassFilters(
	...
	defer func() {
		...
		metrics.FrameworkExtensionPointDuration.WithLabelValues(metrics.Filter, statusCode.String(), schedFramework.ProfileName(), "false").Observe(metrics.SinceInSeconds(beginCheckNode))
	}()
