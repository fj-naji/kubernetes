...
type DynamicResourcesArgs struct {
	...
	// cleared and the Pod re-enters backoff. If other nodes succeed, they may be
	// chosen instead; otherwise the Pod is placed in the unschedulable queue and
	...
	//   - When DRADeviceBindingConditions is disabled, setting this field is forbidden.
	//
	// Valid values:
